...
<template>
  <div class="flex items-center gap-3.5 py-3 border-b border-slate-100 group">
    ...
    <div class="flex-1 min-w-0">
      <h4
        class="text-xs sm:text-sm font-bold text-slate-800 line-clamp-1 group-hover:text-red-600 transition-colors"
      >
        {{ item.toy.name }}
      </h4>
      ...
      <div class="flex items-center gap-2">
        <span
          class="text-xs sm:text-sm font-extrabold text-red-600 font-display"
        >
    ...
    <div class="flex flex-col items-end gap-1.5 flex-shrink-0">
      <div
        class="flex items-center border border-slate-200 rounded-xl bg-slate-50/70 p-0.5"
      >
        <button
          type="button"
