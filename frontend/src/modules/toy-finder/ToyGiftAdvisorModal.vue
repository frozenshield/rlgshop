...
const ageOptions: {
...
}[] = [
  {
    ...
    label: "Baby & Toddler",
    icon: "🍼",
    desc: "0 - 2 Years (Soft & Cuddle Plush)",
  },
  {
    id: "3-5",
    label: "Rookie Explorer",
    icon: "⚡",
    desc: "3 - 5 Years (Starter Figures & Gear)",
  },
  {
    id: "6-8",
    label: "Junior Collector",
    icon: "🎒",
    desc: "6 - 8 Years (Action Battles & TCG Starter)",
  },
  {
    id: "9-12",
    label: "Ace Collector",
    icon: "🃏",
    desc: "9 - 12 Years (Elite Trainer Boxes & Scale Statues)",
  },
  {
    id: "12+",
    label: "Master Hobbyist",
    icon: "🏆",
    desc: "12+ Years (Rare Booster Boxes & High-End Scales)",
  },
];
      ...
      >
        ...
        >
            ...
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <h3 class="text-lg font-extrabold text-slate-900">
                  RLG Collector &amp; Gift Matcher
                </h3>
                <p class="text-[11px] text-slate-500 font-semibold">
                  Step {{ currentStep }} of 3 - Discover the perfect hobby &amp;
                  TCG collectible
                </p>
              </div>
            </div>
          ...
          <div v-if="currentStep === 1" class="space-y-4">
            <div class="text-center space-y-1">
              <h4 class="text-base font-extrabold text-slate-900">
                Who is this gift or collectible for?
              </h4>
              <p class="text-xs text-slate-500">
                Select experience level or age group to match appropriate items.
              </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              ...
              >
                ...
                <div>
                  <h5
                    class="text-xs font-extrabold text-slate-800 group-hover:text-slate-900 transition-colors"
                  >
                    {{ opt.label }}
                  </h5>
          ...
          <div v-else-if="currentStep === 2" class="space-y-4">
            <div class="text-center space-y-1">
              <h4 class="text-base font-extrabold text-slate-900">
                Which franchise or category are you looking for?
              </h4>
              <p class="text-xs text-slate-500">
                Pick a specific TCG franchise or anime collectible type.
              </p>
            </div>
            ...
            <div class="space-y-2 pt-1">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                >
                  ...
                  <div class="min-w-0">
                    <h5
                      class="text-xs font-extrabold text-slate-800 group-hover:text-slate-900 transition-colors truncate"
                    >
                      {{ series.name }}
                    </h5>
            ...
            <!-- Gunpla, Figures & Merchandise -->
            <div class="space-y-2 pt-2 border-t border-slate-100">
              <span
                class="text-[11px] font-extrabold uppercase tracking-wider text-slate-400"
                >🤖 Gunpla, Figures &amp; Merch</span
              >
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <button
                  type="button"
                  class="p-3 rounded-2xl border-2 border-slate-200 hover:border-slate-900 hover:bg-slate-50/70 transition-all text-left flex items-center gap-3 group cursor-pointer"
                  @click="selectInterest('gunpla')"
                >
                  <span
                    class="text-2xl group-hover:scale-110 transition-transform"
                    >🤖</span
          ...
          <div v-else-if="currentStep === 3" class="space-y-5">
            <div class="text-center space-y-1">
              ...
              <p class="text-xs text-slate-500">
                We will find the highest-rated collectibles within your price
                range.
              </p>
            </div>

            <div
              class="bg-slate-50 p-6 rounded-3xl border border-slate-200 text-center space-y-3"
            >
              ...
              />
              <div
                class="flex justify-between text-xs text-slate-400 font-bold"
              >
          ...
          <div v-else-if="currentStep === 4" class="space-y-4">
            <div class="text-center space-y-1">
              ...
              <p class="text-xs text-slate-500">
                Custom recommendations for Rank:
                {{ formatAgeGroup(selectedAge || "all") }}
              </p>
            </div>
