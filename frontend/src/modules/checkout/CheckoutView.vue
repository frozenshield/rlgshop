...
const currentDeliveryOption = ref<'standard' | 'express' | 'gift-wrapped'>('standard')
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-amber-200/80 pb-5">
        ...
        <div class="flex items-center gap-2 text-xs font-bold text-slate-500">
          ...
          <span class="text-red-600 bg-red-50 px-3 py-1 rounded-full border border-red-200">
            Trainer Dispatch
          </span>
          <span class="text-slate-300">&gt;</span>
      ...
      >
        ...
        <h3 class="text-xl font-bold text-slate-800">Your Poké-Bag is Currently Empty</h3>
